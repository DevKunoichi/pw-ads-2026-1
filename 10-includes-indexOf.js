const carros = ['Chevette', 'Fusca', 'Opala', 'Maverick', 'Belina',
    'Del Rey']
    /*
    O método includes() testa se um determinado elemento existe
    no vetor. Retorna tru se existir, ou false, caso cotrário.
    */
...
em 2015. Anteriormente, para testar se um elemento existia 
no vetor, era o necessário testar o resultado do indexOf() 
era maior ou gial a zero.
*/
