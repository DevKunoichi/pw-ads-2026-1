...
- a palavra-chave function é substituída por flecha
...
=> quando o número de parâmetros é DIFERENTE DE 1, os PARÊNTESES
...
É COMUM ENCONTRAR ARROW FUNCTIONS DE VÁRIAS LINHAS EM 
PROJETOS REACT PROFISSIONAIS 
=> As chaves voltam a ser obrigatórias, assim como a 
