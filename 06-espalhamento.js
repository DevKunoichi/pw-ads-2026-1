...
/*
    ...
    do nome de uma variável que contém um vetor, é capaz 
...
// e ele, podemos usar a sintaxe de espalahamento. Ela "desmonta" o 
...
*/
function soma(...nums) {
// nums é recebido dento da função como um vetor
    let resultado = 0
